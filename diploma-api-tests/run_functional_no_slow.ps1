...
function Assert-TestConfigPresent {
    ...
    if ($missing.Count -gt 0) {
        Write-Host ''
        Write-Host 'Functional run preflight failed: configuration is incomplete.' -ForegroundColor Red
...
$reportsDir = Join-Path $PSScriptRoot 'reports\functional_no_slow'
